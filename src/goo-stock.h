...
#define GOO_STOCK_NEXT        "gtk-media-next"
#define GOO_STOCK_PAUSE       "gtk-media-pause"
#define GOO_STOCK_PLAY        "gtk-media-play"
#define GOO_STOCK_PREV        "gtk-media-previous"
